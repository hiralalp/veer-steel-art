...
$pages = @{
    ...
    'ramdev-tables' = @{Title='Steel Tables'; Folder='table'; Keyword='Tables, Furniture'; Prefix='table-'; Max=48}
    'ramdev-chairs' = @{Title='Steel Chairs & Stools'; Folder='chairs'; Keyword='Chairs, Stools'; Prefix='chairs-'; Max=22}
    'ramdev-kitchen' = @{Title='Kitchen Items'; Folder='kitchen'; Keyword='Kitchen, Trolley'; Prefix='kitchen-'; Max=7}
    'ramdev-pvd-coating' = @{Title='PVD Coating'; Folder='RSI-PVD'; Keyword='PVD Coating'; Prefix='RSI-PVD-'; Max=20}
    'ramdev-laser-cutting' = @{Title='Laser Cutting'; Folder='RSI-LC'; Keyword='Laser Cutting'; Prefix='RSI-LC-'; Max=10}
    'ramdev-accessories' = @{Title='Steel Accessories'; Folder='a-series'; Keyword='Accessories'; Prefix='a'; Max=26}
    'ramdev-nameplates' = @{Title='Name Plates'; Folder='n-series'; Keyword='Name Plates'; Prefix='n'; Max=39}
}
...
foreach ($pageName in $pages.Keys) {
    ...
    $imagePath = "img\ramdev\$folder"
    $images = Get-ChildItem -Path $imagePath -File -Filter "*.jpg" | Select-Object -First $max
        ...
        $imageHtml += @"
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="${delay}s">
                <div class="project-item">
                    <img class="img-fluid" src="img/ramdev/$folder/$($img.Name)" alt="$title">
                    <a class="project-title h5 mb-0" href="img/ramdev/$folder/$($img.Name)" data-lightbox="gallery"></a>
                </div>
            </div>
...
"@
    ...
    Write-Host "Created $pageName.html with $($images.Count) images"
}
